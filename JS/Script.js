...
function crearmenu() {
    let men = '';
    for (var i = 0; i < 71; i++) {
        men += '<div class="col"><button id="btnEje' + (i + 1) + '" onclick=" mostrar_contenido(' + (i + 1) + ')">Ejercicio ' + (i + 1) + '</button></div>';
    }
...
function ejercicio1() {
    ...
    opSuma.addEventListener('click', () => {
        ...
        if (isNaN(N_1) || isNaN(N_2)) {
            ...
            insertTexto('res-eje1', "Suma: " + N_1 + " + " + N_2 + " = " + (N_1 + N_2));
        }
    })
    opResta.addEventListener('click', () => {
        ...
        if (isNaN(N_1) || isNaN(N_2)) {
            ...
            insertTexto('res-eje1', "Resta: " + N_1 + " - " + N_2 + " = " + (N_1 - N_2));
        }
    })
    opMultiplicacion.addEventListener('click', () => {
        ...
        if (isNaN(N_1) || isNaN(N_2)) {
            ...
            insertTexto('res-eje1', "Multiplicación: " + N_1 + " * " + N_2 + " = " + (N_1 * N_2));
        }
    })
    opDivision.addEventListener('click', () => {
        ...
        if (isNaN(N_1) || isNaN(N_2)) {
            ...
            if (N_2 == 0)
                ...
                insertTexto('res-eje1', "División: " + N_1 + " / " + N_2 + " = " + (N_1 / N_2));
        }
    })
}
...
function ejercicio4() {
    ...
    btnOrder.addEventListener('click', () => {
        ...
        if (isNaN(N_1) || isNaN(N_2) || isNaN(N_3)) {
            ...
            insertTexto('res-eje4', "Menor: " + menor + " Medio: " + medio + " Mayor: " + mayor);
        }
    })
}
    ...
    btnVerify.addEventListener('click', () => {
        ...
        if (optRadio) {
            ...
            btnVerify2.addEventListener('click', () => {
                ...
                let valorTotal = 0;
                let inpCantidadRosas = parseInt(document.getElementById('cantidadRosas').value);
                let optRadio = document.getElementsByName('colorR');
                let opcionSeleccionada;
                ...
                if (isNaN(inpCantidadRosas)) {
                    ...
                    switch (opcionSeleccionada) {
                        case 'Rojo':
                            valorDescuento = (4000 * inpCantidadRosas) * 0.10;
        ...
        if (isNaN(productoVendido) || isNaN(valorTotalVendido)) {
            ...
            if (productoVendido < 0 || productoVendido > 100) {
                ...
                if (productoVendido <= 20) {
                    ...
                    porcentajeGanado = (valorTotalVendido * 0.10);
                    ...
                    porcentajeGanado = (valorTotalVendido * 0.20);
                }
                insertTexto('res-eje9', "Valor Porcentaje Ganado: $" + porcentajeGanado);
            }
        }
    })
}
    ...
    document.getElementById('eje10_verify').addEventListener('click', () => {
        ...
        if (opcRadio) {
            ...
            if (isNaN(modelo) || marca == "") {
                ...
                insertTexto('res4-eje10', "<strong>Color:</strong> " + opcionSeleccionada);
                insertTexto('res6-eje10', "<strong>Precio Final:</strong> $" + precioFinal);
            }
        } else {
    ...
    document.getElementById('eje12_verify').addEventListener('click', () => {
        ...
        if (isNaN(valor)) {
            ...
            if ((valor >= 10) && (valor <= 30)) {
                ...
                insertTexto('res2-eje12', "<strong>Suma Total Serie:</strong> " + sumaSerie);
                insertTexto('res3-eje12', "<strong>Números Mostrados:</strong> " + (i - 1))
            } else {
    ...
    document.getElementById('eje14_verify').addEventListener('click', () => {
        ...
        if (isNaN(valor)) {
            ...
            if (valor <= 10) {
                ...
                insertTexto('res2-eje14', "<strong>Impares:<br></strong> " + msjImpares);
                insertTexto('res3-eje14', "<strong>Suma <br>Pares:<br></strong> " + sumaPares);
                insertTexto('res4-eje14', "<strong>Suma Impares:<br></strong> " + sumaImpares);
                insertTexto('res5-eje14', "<strong>Promedio Pares:<br></strong> " + (sumaPares / cantidadPares));
                insertTexto('res6-eje14', "<strong>Promedio Impares:<br></strong> " + (sumaImpares / cantidadImpares));
                insertTexto('res7-eje14', "<strong>Diferencia Pares-Impares:<br></strong> " + (Math.abs(sumaPares - sumaImpares)));
            }
        }
    })
}
...
function ejercicio17() {
    document.getElementById('eje17_verify').addEventListener('click', () => {
        ...
        if (isNaN(valor1) || isNaN(valor2)) {
            ...
            insertTexto('res-eje17', "Números primos en el rango [" + valor1 + ", " + valor2 + "]: ");
...
function ejercicio20() {
    document.getElementById('eje20_verify').addEventListener('click', () => {
        ...
        if (isNaN(limite)) {
            ...
            insertTexto('res1-eje20', "<strong>Números Generados:<br></strong> " + msj1);
            insertTexto('res2-eje20', "<strong>Números Pares:<br></strong> " + msj2);
            insertTexto('res3-eje20', "<strong>Números Impares:<br></strong> " + msj3);
            insertTexto('res4-eje20', "<strong>Números Primos:<br></strong> " + msj4);
            insertTexto('res5-eje20', "<strong>Números Compuestos:<br></strong> " + msj5);
        }
    })
}
...
function ejercicio22() {
    document.getElementById('eje22_verify').addEventListener('click', () => {
        ...
        if (isNaN(N_1) || isNaN(N_2) || isNaN(N_3) || isNaN(N_4)) {
            ...
            if ((N_1 < 0 || N_1 > 5) || (N_2 < 0 || N_2 > 5) || (N_3 < 0 || N_3 > 5) || (N_4 < 0 || N_4 > 5)) {
...
function ejercicio24() {
    document.getElementById('eje24_verify').addEventListener('click', () => {
        ...
        if (isNaN(radio)) {
            ...
            insertTexto('res-eje24', "<b>Área Circunferencia:<br></b>" + (Math.PI * (radio ** 2)));
        }
    })
}
...
function ejercicio25() {
    document.getElementById('eje25_verify').addEventListener('click', () => {
        ...
        if (isNaN(base) || isNaN(alturaTrg) || isNaN(alturaRtg)) {
            ...
            insertTexto('res1-eje25', "<b>Área Triángulo:<br></b>" + areaTrg.toFixed(2) + " Mts");
            insertTexto('res2-eje25', "<b>Área Rectangulo:<br></b>" + areaRtg.toFixed(2) + " Mts");
            insertTexto('res3-eje25', "<b>Área Total:<br></b>" + areaTot.toFixed(2) + " Mts");
        }
    })
}
...
function ejercicio26() {
    document.getElementById('eje26_verify').addEventListener('click', () => {
        ...
        if (isNaN(hipotenusa) || isNaN(mdBase_radio)) {
            ...
            insertTexto('res1-eje26', "<b>Área Triángulo:<br></b>" + areaTrg.toFixed(2) + " Mts");
            insertTexto('res2-eje26', "<b>Área Circulo:<br></b>" + areaCrl.toFixed(2) + " Mts");
            insertTexto('res3-eje26', "<b>Área Total:<br></b>" + areaTot.toFixed(2) + " Mts");
        }
    })
}
...
function ejercicio27() {
    document.getElementById('eje27_verify').addEventListener('click', () => {
        ...
        if (isNaN(litros) || isNaN(precio)) {
            ...
            insertTexto('res1-eje27', "<b>Litros Producidos:<br></b> " + litros + "L");
            insertTexto('res2-eje27', "<b>Galónes Producidos:<br></b> " + galon.toFixed(2) + "Gal");
            insertTexto('res3-eje27', "<b>Precio Final:<br></b> $" + precioFinal.toFixed(2));
        }
    })
}
...
function ejercicio28() {
    document.getElementById('eje28_verify').addEventListener('click', () => {
        ...
        if (isNaN(X1) || isNaN(X2) || isNaN(Y1) || isNaN(Y2)) {
            ...
            insertTexto('res-eje28', "Distancia entre los puntos <b>[" + X1 + ", " + X2 + "]</b> y <b>[" + Y1 + ", " + Y2 + "]</b><br>" + distancia.toFixed(3))
        }
    })
}
...
function ejercicio30() {
    document.getElementById('eje30_verify').addEventListener('click', () => {
        ...
        if (isNaN(altura) || isNaN(ancho) || isNaN(largo)) {
            ...
            pago = (costo * volumen);
            insertTexto('res-eje30', "<b>Volumen Alberca:</b><br>" + volumen.toFixed(2) + "M2");
            insertTexto('res2-eje30', "<b>Pago Metro Cúbico:</b><br>$" + costo.toFixed(2));
...
function ejercicio33() {
    document.getElementById('eje33_verify').addEventListener('click', () => {
        ...
        if (isNaN(cantLapices)) {
            ...
            insertTexto('res-eje33', "Valor lapiz: $" + costoLapices + "<br>Valor Total: $" + (costoLapices * cantLapices));
        }
    })
}
...
function ejercicio34() {
    document.getElementById('eje34_verify').addEventListener('click', () => {
        ...
        if (isNaN(costoVestido)) {
            ...
            insertTexto('res-eje34', "<b>Descuento: </b><br>" + descuento + "%<br>" + "Precio Final: <br>$" + precioFinal);
        }
    })
}
...
function ejercicio36() {
    document.getElementById('eje36_verify').addEventListener('click', () => {
        ...
        if (isNaN(nPersonas) == true) {
            ...
            insertTexto('res-eje36', "Costo Plato: <br>$" + costoPlato + "<br><b>Valor a pagar: </b><br>$" + pagoTotal);
        }
    });
}
    ...
    document.getElementById('eje37_verify').addEventListener('click', () => {
        ...
        if (opR1 || opR2) {
            if (isNaN(KlUva)) {
                ...
                insertTexto('res3-eje37', "<b>Precio Producto: </b><br>$" + precioProducto);
...
function ejercicio38() {
    document.getElementById('eje38_verify').addEventListener('click', () => {
        ...
        if (isNaN(cantEsts)) {
            ...
            insertTexto('res2-eje38', "Pago Estudiante: <br>" + pagoAlumno.toFixed(2));
    ...
    document.getElementById('eje39_verify').addEventListener('click', () => {
        ...
        if (isNaN(tiempo) || dia == "") {
            ...
            if (turno) {
                ...
                if (dia == 'l' || dia == 'm' || dia == 'mi' || dia == 'j' || dia == 'v' || dia == 's' || dia == 'd') {
                    switch (dia) {
                        case 'l':
                            nomDia = "Lunes";
                            break;
                    ...
                    insertTexto('res2-eje39', "<b>Día y Turno:</b> <br>" + nomDia + "<br>" + opSeleccionada);
                    insertTexto('res3-eje39', "<b>Impuesto: </b><br>" + impueto + "%");
                    insertTexto('res4-eje39', "<b>Total:</b> <br>$" + pagoTiempo.toFixed(2));
                } else {
                    insertTexto('res1-eje39', "");
                    insertTexto('res2-eje39', "");
                    insertTexto('res3-eje39', "");
        ...
        if (isNaN(cantPersonas)) {
            ...
            if (TBus) {
                ...
                if (cantPersonas > 0) {
                    ...
                    insertTexto('res-eje40', "<b>Tipo Bus: </b><br>" + opSelect + "<br><b>Total Pago: </b>$" + pagoTotal);
                } else {
        ...
        if (isNaN(peso)) {
            ...
            if (ubicacion) {
                if (peso > 5) {
                    ...
                    insertTexto('res2-eje42', "<b>Costo Minimo: </b><br>$" + costoDestino);
                    insertTexto('res3-eje42', "<b>Total: </b><br>$" + costoFinal.toFixed(2));
                }
            } else {
...
function ejercicio43() {
    ...
    document.getElementById('eje43_verify').addEventListener('click', () => {
        ...
        for (var i = 0; i < cantTarjetas; i++) {
            msj += '<div class="radios" id="eje43-radios' + (i + 1) + '"><label for="tipoTarjeta">Tipo de tarjeta ' + (i + 1) + '</label><section class="col rads"><input type="radio" name="tipoTarjeta' + (i + 1) + '" id="Eje43-' + (i + 1) + '_Op1" value="1"/><label for="Eje43-' + (i + 1) + '_Op1">1</label></section ><section class="col rads"><input type="radio" name="tipoTarjeta' + (i + 1) + '" id="Eje43-' + (i + 1) + '_Op2" value="2" /><label for="Eje43-' + (i + 1) + '_Op2">2</label></section><section class="col rads"><input type="radio" name="tipoTarjeta' + (+i + 1) + '" id="Eje43-' + (i + 1) + '_Op3" value="3" /><label for="Eje43-' + (i + 1) + '_Op3">3</label></section></div>';
        }
        ...
        document.getElementById('eje43_verify2').addEventListener('click', () => {
            ...
            for (var i = 0; i < cantTarjetas; i++) {
                ...
                document.getElementById('eje43-radios' + (i + 1)).style.display = 'none';
                document.getElementById('eje43_verify2').style.display = 'none';
            ...
            let msj2 = '';
            for (var i = 0; i < cantTarjetas; i++) {
                msj2 += '<section class="col rads"><input type="radio" name="aplTarjeta" id="Eje43-' + (i + 1) + '_apl" value="' + (i + 1) + '" /><label for="Eje43-' + (i + 1) + '_apl">Tarjeta ' + (i + 1) + '</label></section>';
            }
    ...
    document.getElementById('eje44_verify').addEventListener('click', () => {
        ...
        if (isNaN(valCompra)) {
            ...
            if (valCompra < 0) {
                ...
                insertTexto('res-eje44', "Por tu compra, Supermercados SM <br><b>TE PREMIA</b><br>Da click en Girar");
                ...
                btnGirar.addEventListener('click', () => {
                    ...
                    insertTexto('res2-eje44', "<b>¡Felicidades!</b><br>Ganaste: " + "<b>" + premio + "</b>");
    ...
    document.getElementById('eje48_verify').addEventListener('click', () => {
        ...
        if (isNaN(nPersonas)) {
            ...
            if (nPersonas <= 0) {
                ...
                insertTexto('res-eje48', "<b>Porcentaje Hombres: </b><br>" + porcentajeM.toFixed(2) + "%" + "<br><b>Porcentaje Mujeres: </b><br>" + porcentajeF.toFixed(2) + "%");
            }
        }
    })
}
...
function ejercicio49() {
    let msj = '';
    for (let i = 0; i < 5; i++) {
        msj += '<label for="Eje49_N' + (i + 1) + '">Número ' + (i + 1) + '</label><input type="number" name="Eje49_N" id="Eje49_N' + (i + 1) + '" placeholder="Digite un número"/>';
    }
    ...
    document.getElementById('eje49_verify').addEventListener('click', () => {
        ...
        let iteraciones = '';
        for (let i = 0; i < 5; i++) {
            valores[i] = parseFloat(document.getElementById('Eje49_N' + (i + 1)).value);
        }
        for (let i = 0; i < valores.length; i++) {
            suma += valores[i];
            iteraciones++;
...
function ejercicio51() {
    document.getElementById('eje51_verify').addEventListener('click', () => {
        ...
        insertTexto('res2-eje51', "<b>Ventas Mayores a 550: </b><br>" + fltV550.length + "<br><b>Promedio: </b><br>$" + promedio1.toFixed(2));
        insertTexto('res3-eje51', "<b>Ventas Mayores a 200 y Menores-Iguales a 550: </b><br>" + fltV200_550.length + "<br><b>Promedio: </b><br>$" + promedio2.toFixed(2));
    })
}
...
function ejercicio53() {
    ...
    btn1.addEventListener('click', () => {
        ...
        if (isNaN(limite)) {
            ...
            for (let i = 0; i < limite; i++) {
                msj += '<label for="Eje53-alm_N' + (i + 1) + '">Edad Alumno ' + (i + 1) + '</label><input type="number" name="Eje53_N" id="Eje53-alm_N' + (i + 1) + '" placeholder="Digite un número"/>'
            }
            bxAlm.innerHTML = msj;
...
function ejercicio54() {
    document.getElementById('eje54_verify').addEventListener('click', () => {
        ...
        if (isNaN(limite)) {
            ...
            insertTexto('res1-eje54', "<b>Promedio: </b><br>" + promedio.toFixed() + "cm");
        }
    })
}
